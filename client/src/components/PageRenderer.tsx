 ...
 * 3. Wrapping with global components (Header, SEO)
 *
 * Note: Footer is now handled as a section (luxury-footer) in the page data
 */
...
export function PageRenderer({ pageData }: PageRendererProps) {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:bg-[var(--dusty-rose)] focus:text-white focus:px-4 focus:py-2 focus:outline-none"
      >
