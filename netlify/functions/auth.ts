...
/**
 * Auth function for Sveltia CMS
 *
 * This returns a GitHub PAT from environment variables.
 * The user authenticates via Netlify Identity (email/password),
 * then Sveltia uses this PAT for all GitHub operations.
 *
